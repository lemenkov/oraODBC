 ...
 *******************************************************************************
 *
 * $Id: SQLGetDescField.c,v 1.2 2002/02/20 03:09:05 dbox Exp $
 *
 ...
 * 
 * Revision 1.2  2000/04/19 15:27:15  tom
...
static char const rcsid[] = "$RCSfile: SQLGetDescField.c,v $ $Revision: 1.2 $";
