 ...
 *******************************************************************************
 *
 * $Id: SQLSetPos.c,v 1.1 2002/02/11 19:48:07 dbox Exp $
 *
 * $Log: SQLSetPos.c,v $
...
static char const rcsid[]= "$RCSfile: SQLSetPos.c,v $ $Revision: 1.1 $";
...
#endif
    fprintf(stderr,"called stubbed function %d file %s\n",__LINE__,__FILE__);
    return SQL_SUCCESS;
}
