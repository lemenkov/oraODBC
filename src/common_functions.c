...
const char * sql_get_info_type(SQLSMALLINT sqltype)
{
  ...
  case SQL_ACTIVE_ENVIRONMENTS: return "SQL_ACTIVE_ENVIRONMENTS";
  case SQL_AGGREGATE_FUNCTIONS: return "SQL_AGGREGATE_FUNCTIONS";
  case SQL_ALTER_DOMAIN: return "SQL_ALTER_DOMAIN";
  ...
  case SQL_CATALOG_LOCATION: return "SQL_CATALOG_LOCATION";
  case SQL_CATALOG_NAME: return "SQL_CATALOG_NAME";
  case SQL_CATALOG_NAME_SEPARATOR: return "SQL_CATALOG_NAME_SEPARATOR";
  case SQL_CATALOG_TERM: return "SQL_CATALOG_TERM";
  case SQL_CATALOG_USAGE: return "SQL_CATALOG_USAGE";
  case SQL_COLLATION_SEQ: return "SQL_COLLATION_SEQ";
  case SQL_COLUMN_ALIAS: return "SQL_COLUMN_ALIAS";
  ...
  case SQL_CONVERT_FUNCTIONS: return "SQL_CONVERT_FUNCTIONS";
  case SQL_CONVERT_INTEGER: return "SQL_CONVERT_INTEGER";
  case SQL_CONVERT_INTERVAL_DAY_TIME: return "SQL_CONVERT_INTERVAL_DAY_TIME";
  case SQL_CONVERT_INTERVAL_YEAR_MONTH: return "SQL_CONVERT_INTERVAL_YEAR_MONTH";
  ...
  case SQL_CONVERT_WCHAR: return "SQL_CONVERT_WCHAR";
  case SQL_CONVERT_WLONGVARCHAR: return "SQL_CONVERT_WLONGVARCHAR";
  case SQL_CONVERT_WVARCHAR: return "SQL_CONVERT_WVARCHAR";
  case SQL_CORRELATION_NAME: return "SQL_CORRELATION_NAME";
  case SQL_CREATE_ASSERTION: return "SQL_CREATE_ASSERTION";
  case SQL_CREATE_CHARACTER_SET: return "SQL_CREATE_CHARACTER_SET";
  case SQL_CREATE_COLLATION: return "SQL_CREATE_COLLATION";
  case SQL_CREATE_DOMAIN: return "SQL_CREATE_DOMAIN";
  case SQL_CREATE_SCHEMA: return "SQL_CREATE_SCHEMA";
  case SQL_CREATE_TABLE: return "SQL_CREATE_TABLE";
  case SQL_CREATE_TRANSLATION: return "SQL_CREATE_TRANSLATION";
  case SQL_CREATE_VIEW: return "SQL_CREATE_VIEW";
  case SQL_CURSOR_COMMIT_BEHAVIOR: return "SQL_CURSOR_COMMIT_BEHAVIOR";
  case SQL_CURSOR_ROLLBACK_BEHAVIOR: return "SQL_CURSOR_ROLLBACK_BEHAVIOR";
  ...
  case SQL_DATETIME_LITERALS: return "SQL_DATETIME_LITERALS";
  case SQL_DBMS_NAME: return "SQL_DBMS_NAME";
  case SQL_DBMS_VER: return "SQL_DBMS_VER";
  case SQL_DDL_INDEX: return "SQL_DDL_INDEX";
  case SQL_DESCRIBE_PARAMETER: return "SQL_DESCRIBE_PARAMETER";
  case SQL_DM_VER: return "SQL_DM_VER";
  case SQL_DRIVER_HDBC: return "SQL_DRIVER_HDBC";
  case SQL_DRIVER_HDESC: return "SQL_DRIVER_HDESC";
  case SQL_DRIVER_HENV: return "SQL_DRIVER_HENV";
  case SQL_DRIVER_HLIB: return "SQL_DRIVER_HLIB";
  case SQL_DRIVER_HSTMT: return "SQL_DRIVER_HSTMT";
  case SQL_DRIVER_NAME: return "SQL_DRIVER_NAME";
  case SQL_DRIVER_ODBC_VER: return "SQL_DRIVER_ODBC_VER";
  case SQL_DRIVER_VER: return "SQL_DRIVER_VER";
  case SQL_DROP_ASSERTION: return "SQL_DROP_ASSERTION";
  case SQL_DROP_CHARACTER_SET: return "SQL_DROP_CHARACTER_SET";
  case SQL_DROP_COLLATION: return "SQL_DROP_COLLATION";
  case SQL_DROP_DOMAIN: return "SQL_DROP_DOMAIN";
  case SQL_DROP_SCHEMA: return "SQL_DROP_SCHEMA";
  case SQL_DROP_TABLE: return "SQL_DROP_TABLE";
  case SQL_DROP_TRANSLATION: return "SQL_DROP_TRANSLATION";
...
case SQL_FILE_USAGE: return "SQL_FILE_USAGE";
  ...
  case SQL_GETDATA_EXTENSIONS: return "SQL_GETDATA_EXTENSIONS";
  case SQL_GROUP_BY: return "SQL_GROUP_BY";
  case SQL_IDENTIFIER_CASE: return "SQL_IDENTIFIER_CASE";
  case SQL_IDENTIFIER_QUOTE_CHAR: return "SQL_IDENTIFIER_QUOTE_CHAR";
  case SQL_INDEX_KEYWORDS: return "SQL_INDEX_KEYWORDS";
  case SQL_INFO_SCHEMA_VIEWS: return "SQL_INFO_SCHEMA_VIEWS";
  case SQL_INSERT_STATEMENT: return "SQL_INSERT_STATEMENT";
  case SQL_INTEGRITY: return "SQL_INTEGRITY";
  ...
  case SQL_MAX_ASYNC_CONCURRENT_STATEMENTS: return "SQL_MAX_ASYNC_CONCURRENT_STATEMENTS";
  case SQL_MAX_BINARY_LITERAL_LEN: return "SQL_MAX_BINARY_LITERAL_LEN";
  case SQL_MAX_CATALOG_NAME_LEN: return "SQL_MAX_CATALOG_NAME_LEN";
  ...
  case SQL_MAX_CONCURRENT_ACTIVITIES: return "SQL_MAX_CONCURRENT_ACTIVITIES";
  case SQL_MAX_CURSOR_NAME_LEN: return "SQL_MAX_CURSOR_NAME_LEN";
  case SQL_MAX_DRIVER_CONNECTIONS: return "SQL_MAX_DRIVER_CONNECTIONS";
  case SQL_MAX_IDENTIFIER_LEN: return "SQL_MAX_IDENTIFIER_LEN";
  case SQL_MAX_INDEX_SIZE: return "SQL_MAX_INDEX_SIZE";
    /*case SQL_MAX_LENGTH: return "SQL_MAX_LENGTH";*/
  ...
  case SQL_ODBC_INTERFACE_CONFORMANCE: return "SQL_ODBC_INTERFACE_CONFORMANCE";
  ...
  case SQL_PARAM_ARRAY_SELECTS: return "SQL_PARAM_ARRAY_SELECTS";
  ...
  case SQL_SQL92_NUMERIC_VALUE_FUNCTIONS: return "SQL_SQL92_NUMERIC_VALUE_FUNCTIONS";
  case SQL_SQL92_PREDICATES: return "SQL_SQL92_PREDICATES";
  case SQL_SQL92_RELATIONAL_JOIN_OPERATORS: return "SQL_SQL92_RELATIONAL_JOIN_OPERATORS";
