			     ...
			     SQLSMALLINT * StringLengthPtr)
{
	...
	case SQL_CONVERT_BIGINT:
		*(SQLUINTEGER *) InfoValuePtr =
		    SQL_CVT_BIGINT | SQL_CVT_NUMERIC;
		break;

	case SQL_CONVERT_BINARY:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_BINARY;
		break;

	case SQL_CONVERT_BIT:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_BIT;
		break;

	case SQL_CONVERT_CHAR:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_CHAR | SQL_CVT_VARCHAR;
		break;

	case SQL_CONVERT_DATE:
		*(SQLUINTEGER *) InfoValuePtr =
		    SQL_CVT_DATE |
		    SQL_CVT_TIMESTAMP | SQL_CVT_CHAR | SQL_CVT_VARCHAR;
		break;
	...
	case SQL_CONVERT_DOUBLE:
		*(SQLUINTEGER *) InfoValuePtr =
		    SQL_CVT_DOUBLE |
		    SQL_CVT_NUMERIC | SQL_CVT_CHAR | SQL_CVT_VARCHAR;
		break;
	...
	case SQL_CONVERT_TINYINT:
		*(SQLUINTEGER *) InfoValuePtr =
		    ...
		    SQL_CVT_VARCHAR |
		    SQL_CVT_INTEGER |
		    SQL_CVT_BIGINT | SQL_CVT_SMALLINT | SQL_CVT_NUMERIC;
		break;
	...
	case SQL_CONVERT_LONGVARBINARY:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_LONGVARBINARY;
		break;

	case SQL_CONVERT_LONGVARCHAR:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_LONGVARCHAR;
		break;

	case SQL_CONVERT_NUMERIC:
		*(SQLUINTEGER *) InfoValuePtr =
		    SQL_CVT_CHAR | SQL_CVT_VARCHAR | SQL_CVT_NUMERIC;
		break;
	...
	case SQL_CONVERT_VARBINARY:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CVT_VARBINARY;
		break;
	...
	case SQL_CREATE_TABLE:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CT_CREATE_TABLE | SQL_CT_TABLE_CONSTRAINT | SQL_CT_CONSTRAINT_NAME_DEFINITION | SQL_CT_COMMIT_DELETE | SQL_CT_GLOBAL_TEMPORARY | SQL_CT_COLUMN_CONSTRAINT | SQL_CT_COLUMN_DEFAULT | SQL_CT_CONSTRAINT_INITIALLY_IMMEDIATE |	/* guess */
		    SQL_CT_CONSTRAINT_NON_DEFERRABLE;	/* guess */
		break;

	case SQL_CREATE_VIEW:
		*(SQLUINTEGER *) InfoValuePtr = SQL_CV_CREATE_VIEW | SQL_CV_CHECK_OPTION | SQL_CV_CASCADED;	/*guess */
		break;
	...
	case SQL_DBMS_NAME:
		ood_bounded_strcpy(InfoValuePtr, ERROR_PRODUCT, BufferLength);
		if (StringLengthPtr)
	...
	case SQL_DEFAULT_TXN_ISOLATION:
		*(SQLUINTEGER *) InfoValuePtr = SQL_TXN_SERIALIZABLE;
		break;
	...
	case SQL_DROP_VIEW:
		*(SQLUINTEGER *) InfoValuePtr = SQL_DV_DROP_VIEW;
		break;
	...
	case SQL_FILE_USAGE:
		*(SQLUINTEGER *) InfoValuePtr = SQL_FILE_NOT_SUPPORTED;
		break;

	case SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES1:
		/*TODO*/ *(SQLUINTEGER *) InfoValuePtr = SQL_CA1_NEXT;
		break;

	case SQL_FORWARD_ONLY_CURSOR_ATTRIBUTES2:
		*(SQLUINTEGER *) InfoValuePtr =
		    SQL_CA2_READ_ONLY_CONCURRENCY | SQL_CA2_CRC_APPROXIMATE;
		break;
