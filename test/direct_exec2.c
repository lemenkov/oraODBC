 ...
 * $Id: direct_exec2.c,v 1.4 2002/06/26 21:02:23 dbox Exp $
 */
...
int main()
{
  ...
  GET_LOGIN_VARS();
    ...
    sprintf(SQLStmt,"create table some_numeric_types (anInteger	INTEGER, ");
    strcat(SQLStmt," anInt INT,aSmallInt SMALLINT, aDecimal83 DECIMAL(8,3), ");
    strcat(SQLStmt,"aNumeric94 NUMERIC(9,4), aFloat FLOAT ,aFloat9 FLOAT(9),");
